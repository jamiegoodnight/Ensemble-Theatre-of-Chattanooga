  ...
  return (
    <div className='spec-wrapper'>
        ...
        <div className='spec-about'>
            ...
            <p className='spec-text spec'> The Spectrum Playhouse is the culmination of a partnership between Ensemble Theatre of Chattanooga and The Chattanooga Autism Center. It seeks to combine the resources, skills, and talents of both to create a new organization that combines
