      ...
      <div className='tl-box-container'>
        ...
        <div className='tl-box'>
          <div className='inner-box box-2'>
            ...
            <h4>Equality</h4>
            <p>
              We acknowledge the struggle for equality endured by Black, Indigenous, and People of Color.  
              We pledge our continued support, assistance and allegiance to using our craft to create a better tomorrow 
              where equality is an expectation and inclusion is the norm.
            </p>
          </div>
        </div>
      </div>
