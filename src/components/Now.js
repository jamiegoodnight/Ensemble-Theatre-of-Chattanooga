  ...
  return (
    ...
    <div className='now-wrapper'>
      ...
      <div className='now-text'>
        ...
        <p>Directed by Ensemble Theatre of Chattanooga veteran Bruce Shaw. The cast includes Casey Keelen and Eric "Red" Wyatt. Don't forget to follow us on Facebook, Twitter, and Instagram for more updates.</p>
      </div>
    </div>
